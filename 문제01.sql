...
select first_name, salary, phone_number from employees where manager_id = 120;


--요구사항.011.employees
--특정 부서(60, 80, 100)에 속한 직원들의 이름, 연락처, 이메일, 부서ID 가져오시오.
select first_name, phone_number, email, job_id from employees where department_id in(60,80,100);
...
select * from tblInsa where city in('서울', '인천', '경기') and ibsadate like '08%' or ibsadate like'09%' or ibsadate like '10%';
